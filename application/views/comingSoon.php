...
<!-- Mirrored from labartisan.net/demo/foodbuzz/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Aug 2020 11:07:00 GMT -->
<head>
		<meta charset="UTF-8">
		...
		<title>FoodBuzz - Comming coming-soon</title>
	</head>
	...
	<body>
       ...
       <!-- Mobile Menu Start Here -->
                ...
                <div class="row flex-row-reverse align-items-center">
                    <div class="col-lg-6 col-12">
                        <div class="coming-thumb">
                            <img src="<?php echo base_url().'assets/images/coming-soon/coming-soon.png'?>" alt="coming-thumb">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="coming-area">
                            ...
                            <div class="section-wrapper">
                                <ul class="countdown d-flex flex-wrap align-items-center">
                                    <li>
                                        <h3><span class="days"></span></h3>
                                        <p class="days_text">Days</p>
                                    </li>
                                    <li>
                                        <h3><span class="hours"></span></h3>
                                        <p class="hours_text">Hours</p>
                                    </li>
                                    <li>
                                        <h3><span class="minutes"></span></h3>
                                        <p class="minu_text">minutes</p>
                                    </li>
                                    <li>
                                        <h3><span class="seconds"></span></h3>
        ...
        <script>
            $(function() {
                var nextyear = '10/22/2020 17:00:00';
                $('.countdown').countdown({
                    date: nextyear,
                    offset: +2,
                    day: 'Day',
